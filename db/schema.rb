...
ActiveRecord::Schema.define(version: 20170119071543) do
  ...
  add_index "file_sources", ["file_md5"], name: "index_file_sources_on_file_md5", unique: true, using: :btree
  ...
  create_table "user_files", force: :cascade do |t|
    ...
    t.string   "cover",        limit: 255
    t.integer  "down_count",   limit: 4,   default: 1
    t.datetime "created_at",                           null: false
    t.datetime "updated_at",                           null: false
  end
